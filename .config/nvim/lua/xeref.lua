...
-- Copy the method reference the cursor is within to the system clipboard
local function copy_method_ref()
...
vim.api.nvim_create_user_command('Xeref', copy_method_ref, {})
