...
const vec4 TRAIL_COLOR = vec4(0.733, 0.604, 0.969, 1.0); // magenta
// const vec4 TRAIL_COLOR = vec4(0.62, 0.808, 0.416, 1.0); // green
// const vec4 TRAIL_COLOR = vec4(0.878, 0.686, 0.408, 1.0); // yellow
// const vec4 TRAIL_COLOR = vec4(1.0, 0.62, 0.392, 1.0); // orange
// const vec4 TRAIL_COLOR = vec4(0.969, 0.463, 0.557, 1.0); // red
